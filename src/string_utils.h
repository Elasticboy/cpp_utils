...
namespace string_utils
{
    ...
    namespace helper
    {
        ...
        /// Arithmetic
        template <typename T>
        std::string helper_arithmetic(const T& arg, std::true_type)
        {
        ...
        /// NOT Arithmetic
        template <typename T>
        std::string helper_arithmetic(const T& arg, std::false_type)
        {
            return arg;
        }
    ...
    template <typename T>
    const std::string replace_string(const std::string& str, const std::string& pattern, const T& arg)
    {
        return helper::replace_string(str, pattern, to_string(arg));
    }

    template <typename T>
    void securedPrint(char* buffer, const int& length, const char* format, const T& arg)
    {
