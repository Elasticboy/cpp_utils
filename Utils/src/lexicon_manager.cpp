...
void lexicon_manager::set_language(const string& language_key)
{
	...
	throw config_exception("lexicon_manager::setLanguage()", "Language \"" + language_key + "\" is not part of the list. lexicon_manager has perhaps not been properly initialized.");
}
